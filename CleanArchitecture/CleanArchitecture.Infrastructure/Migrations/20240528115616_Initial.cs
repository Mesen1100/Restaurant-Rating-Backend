        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatePoint = table.Column<double>(type: "float", nullable: false),
                    RateCount = table.Column<double>(type: "float", nullable: false),
                    CommentCount = table.Column<double>(type: "float", nullable: false),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsShowned = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Places_RelationUsers_ManagerUserId",
                        column: x => x.ManagerUserId,
                        principalTable: "RelationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MenuRate = table.Column<double>(type: "float", nullable: false),
                    MenuRateCount = table.Column<double>(type: "float", nullable: false),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsShowned = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaceComments_RelationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "RelationUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HygieneRate = table.Column<double>(type: "float", nullable: false),
                    PlaceId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaceRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlaceRates_Places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaceRates_RelationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "RelationUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodComments_RelationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "RelationUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasteRate = table.Column<double>(type: "float", nullable: false),
                    FoodId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodRates_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodRates_RelationUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "RelationUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodRates_FoodId",
                table: "FoodRates",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodRates_UserId",
                table: "FoodRates",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaceRates_PlaceId",
                table: "PlaceRates",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaceRates_UserId",
                table: "PlaceRates",
                column: "UserId");
