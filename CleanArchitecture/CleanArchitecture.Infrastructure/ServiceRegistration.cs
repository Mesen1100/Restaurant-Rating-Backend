...
namespace CleanArchitecture.Infrastructure
{
    public static class ServiceRegistration
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IPlaceTypeRepositoryAsync,PlaceTypeRepositoryAsync>();
            services.AddTransient<IPlaceRepositoryAsync, PlaceRepositoryAsync>();
            services.AddTransient<IMenuTypeRepositoryAsync, MenuTypeRepositoryAsync>();
            services.AddTransient<IMenuRepositoryAsync, MenuRepositoryAsync>();
            services.AddTransient<IFoodTypeRepositoryAsync, FoodTypeRepositoryAsync>();
            services.AddTransient<IPlaceRateRepositoryAsync, PlaceRateRepositoryAsync>();
            services.AddTransient<IFoodRepositoryAsync, FoodRepositoryAsync>();
            services.AddTransient<IFoodRateRepositoryAsync, FoodRateRepositoryAsync>();
